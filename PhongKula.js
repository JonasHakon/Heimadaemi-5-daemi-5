...
window.onload = function init() {
    ...
    gl.uniform1i( gl.getUniformLocation(program, "typeOfLighting"), typeOfLighting );
    ...
    document.getElementById("btnChange").onclick = function(){
        typeOfLighting = (typeOfLighting + 1) % 2;
        index = 0;
        pointsArray = []; 
        normalsArray = [];
        init();
...
function render() {
    ...
    //ormal matrix only really need if there is nonuniform scaling
